...
public class calculatorFrame implements ActionListener {
  ...
  Button addBtn, subBtn, divBtn, mulBtn, decBtn, equBtn, delBtn, clrBtn, percentBtn, negBtn, prevBtn, expnBtn, sqrBtn, factBtn;
  ...
  calculatorFrame() {
    ...
    historyPanel.setBounds(500, 70, 200, 560);
    historyPanel.setSize(200, 560);
    historyPanel.add(scroll);
    historyPanel.add(history, BorderLayout.CENTER);
    frame.add(historyPanel);

    //text field for history
    history.setBounds(10, 10, 200, 540);
